...
{
    public partial class rolEliminadosPage : ContentPage
    {
        ...
        private readonly RolEliminadosViewModel viewModel = new();
        ...
        private void AjustarPadding()
        {
            ...
            if (ContenidoRolesEliminados == null ||
                ancho <= 0)
            {
                return;
            }

            ContenidoRolesEliminados.Padding =
                ancho < 600
