...
namespace CONATRADEC.Views
{
    ...
    {
        private readonly TipoAnalisisSueloFormViewModel viewModel = new();

        public FormModeSelect Mode { set => viewModel.Mode = value; }
        public TipoAnalisisSueloRequest Item { set => viewModel.Item = value; }
        ...
        {
            base.OnAppearing();
            viewModel.LoadPagePermissions("tipoAnalisisSueloPage");
            ...
            if (denied)
            {
                ...
                await Shell.Current.GoToAsync(AppRoutes.TiposAnalisisSuelo);
                return;
            }
