...
{
    public partial class departamentoFormPage : ContentPage, IQueryAttributable
    {
        ...
        public void ApplyQueryAttributes(IDictionary<string, object> query)
        {
            ...
            bool tieneDepartamento =
                ...
                departamentoValue is DepartamentoRequest;

            parametrosValidos = tieneModo && tienePais && tieneDepartamento;
            ...
            if (parametrosValidos)
            {
                if ((modePendiente == FormModeSelect.Edit ||
                    ...
                    departamentoPendiente.DepartamentoId is not > 0)
                {
        ...
        private async Task InicializarParametrosPendientesAsync()
        {
            ...
            try
            {
                ...
                viewModel.Departamento = departamentoPendiente;
                ...
                if (denegado)
                {
                    await DisplayAlert(
                        "Permiso denegado",
                        "No tiene permisos para realizar esta operación sobre departamentos.",
                        "Aceptar");
        ...
        {
            await DisplayAlert(
                "No fue posible abrir el departamento",
                "No se recibieron correctamente el país y los datos del formulario.",
                "Aceptar");
        ...
        private Task RegresarAListadoAsync()
        {
            return Shell.Current.GoToAsync(
                ...
                {
                    ["Pais"] = paisPendiente,
                    ["TitlePage"] = $"Departamentos de {paisPendiente.NombrePais}"
                });
        }

        private void AjustarDiseno(double width)
        {
            if (width <= 0 || ContenidoDepartamentoFormulario == null)
                return;

            ContenidoDepartamentoFormulario.Padding =
                width < 600
