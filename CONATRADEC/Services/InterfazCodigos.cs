...
namespace CONATRADEC.Services
{
    ...
    public static class InterfazCodigos
    {
        ...
        public const string Departamentos =
            "departamentoPage";
        public const string Municipios =
            "municipioPage";
        ...
        public const string FuentesNutrientes =
            "fuenteNutrientePage";
            ...
            string> Alias =
                    ...
                    StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    ["ResultadoAnalisisSueloPage"] =
                        AnalisisSuelo,
                    ["ResultadosAnalisisPage"] =
                        AnalisisSuelo,
                    ["BalanceFormulaPage"] =
                        AnalisisSuelo,
                    ["BalanceFormulasPage"] =
                        AnalisisSuelo,
                    ["EnmiendasCalcareasPage"] =
                        AnalisisSuelo,
            ...
            string? nombreApi = null)
        {
            ...
            return HumanizarCodigo(
                codigoNormalizado);
        }

        private static bool PareceCodigoTecnico(
            string valor)
        {
        ...
        private static string HumanizarCodigo(
            string codigo)
        {
            string valor =
                (codigo ?? string.Empty).Trim();
